...
<div class="contain-to-grid header">
  ...
  <?php $arr = array('name'=>'contact-form','id'=>'main-contact-form');?>
                            <?php echo form_open('contact/sendmail',$arr);?>
                ...
                <?php $atrr = array('class'=>'btn btn-primary btn-large pull-right','value'=>'Send Message');?>
