...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url();?>application/views/nova/css/jquery.bxslider.css" />
    ...
    <header class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <font face="cambria" ></font> <img src="<?php echo base_url();?>application/views/nova/images/ico/icon-contact.png">: <span>+254-786 305 030,
                    +254-731 305 030</span>  Email:<span>info@istiglobal.com</span>
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="<?php echo base_url();?>application/views/nova/images/sample/slider/banner2.jpg" alt="" />
...
<!--/Services-->
    ...
    <div class="container">
        <div class="center">
            ...
            <p class="lead">Look at some of the recent projects we have completed for our valuble clients</p>
             <marquee bgcolor="#ffffff" scrolldelay="2" scrollamount="1" direction="left" loop="true" width="100%" height="120px" onMouseOver="this.stop();" onMouseOut="this.start();"> <center> 

                                                    <a href="<?php echo base_url();?>assets/2014/09/amiran.jpg" /></a><br>
                                                    <a href="<?php echo base_url();?>assets/2014/09/antarc.png" /></a><br>
                                                  
                                                   <a href="<?php echo base_url();?>assets/2014/09/BOMA-HOTELS.png" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/brand-track.png" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/Britam.gif" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/cfc.png" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/cheki.gif" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/copycat.gif" /></a><br>
                                                   
                                                   <a href="<?php echo base_url();?>assets/2014/09/CrownBerger.jpg" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/easyfm.png" /></a><br>
                                                   <a href="<?php echo base_url();?>assets/2014/09/ecobank.jpg" /></a><br>
                                                  <a href="<?php echo base_url();?>assets/2014/09/hilton.png" /></a><br>
          
                    
					          <a href="<?php echo base_url();?>assets/2014/09/kbc.png" /></a>
          
                    
					          <a href="<?php echo base_url();?>assets/2014/09/movit.png" /></a>
          
                    
					          <a href="<?php echo base_url();?>assets/2014/09/star.png" /></a>
          
                    
					          <a href="<?php echo base_url();?>assets/2014/09/viscar.png" /></a>
...
<section id="clients" class="main">
    <marquee bgcolor="#ffffff" scrolldelay="2" scrollamount="1" direction="up" loop="true" width="100%" height="120px" onMouseOver="this.stop();" onMouseOut="this.start();"> <center> 

<?php foreach ($events as $res):
           echo'<a href ="/calendar">'.$res['title'].'</a><br/>';
               echo '<em>'. $res['start'].'</em>'. 'to'.'<em>'.$res['end'].'</em><br/>';
              
              
               echo'<em>'.'<b>'.'Learn'.'</b><br/>'.$res['event_description'].'</em><br/>';
                echo'<em>'.'<b>Venue</b><br/>'.$res['venue'].'</em><hr>';
       endforeach;?>
...
<footer id="footer">
    <div class="container">
        <div class="row-fluid">
            ...
            <!--/Copyright-->
<script src="<?php echo base_url();?>application/views/nova/js/jquery.bxslider.min.js"></script>
                ...
                //if (Modernizr.mq('only screen and (min-width: 40.063em)')) {
                  ...
                  if ($.cookie('modal_shown') == null) {
                        $.cookie('modal_shown', 'yes', { 
                          expires: 1, path: '<?php echo base_url();?>' 
                      });
                    $('#myModal').foundation('reveal', 'open');	
                    }
                //}
...
<script src="<?php echo base_url();?>application/views/nova/js/jquery.ba-cond.min.js"></script>
<script src="<?php echo base_url();?>application/views/nova/js/jquery.slitslider.js"></script>
<!-- /Required javascript files for Slider -->
