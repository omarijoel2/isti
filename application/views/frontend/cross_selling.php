...
<aside class="col-md-4 sidebar sidebar-right">
		<div class="row panel">
					<div class="col-xs-12">
						<h2>Cross-Selling: Mining gold in Your Own Back Yard</h2>
                                                <strong>Scope:</strong>
                                                <p>Cross-Selling is intended to enable YOU to understand Cross-Selling as an ADVANCED type of service and employ new attitudes and skills to successfully Cross-Sell and Up-Sell </p>
                                            ...
                                            <ul>
                                                <li>Distinguish between Cross-Selling and Up-Selling</li>
                                                <li> Explain the importance of Cross-Selling</li>
                                              <li>Distinguish between Cross-Selling and Up-Selling</li>
                                                <li> Explain the importance of Cross-Selling</li>
                                                <li>List factors affecting a customers’ Cross-Selling Potential</li>
                                                <li>Develop and Sustain mutually beneficial customer relationships for customer satisfaction</li>
                                                <li>Identify customer needs for possible Cross-Selling opportunities during a selling process</li>
                                                <li> Record, maintain and use customer information to enhance Cross-Selling success</li>
				...
				<div class="row panel">
					...
					<div class="col-xs-122">
                                            ...
                                            <ul> <li>Evolution of consultative selling</li>
                                            <li> Selling attitude</li>
                                            <li>Confidence, Care, Patience</li>
                                            <li> Creating Partnerships</li>
                                            <li> Personal Selling</li>

                                            <li>Creating Partnerships</li>
                                            <li> Ethically Speaking</li>
                                            </ul>
