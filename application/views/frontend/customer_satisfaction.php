		...
		<div class="row panel">
					<div class="col-xs-12">
						<h2>Customer Service Excellence</h2>
                                                <strong>Scope:</strong>
                                                <p>If you make a sale, you can make a living. If you make an investment of time and good service in a customer, you can make a fortune. This is what Customer Service Excellence course will help you achieve.</p>
                                            ...
                                            At the end of Customer Service Excellence course participants will be able to;
                                           	
                                            <ul>
                                                
   <li>Recognize why understanding yourself and your fellow internal customers more, will enhance customer service in your organization.</li>
 <li>Make significant progression toward becoming a more cohesive team.</li>
<li>Commit to raised service standards through the various action points arising from every discussion.</li>
<li>Define Customer Service</li>
<li>Understand the right skills needed in offering excellent customer service</li>
<li>Understand what kind of  service customers expected</li>
 <li>Know what  service quality dimensions are</li>
<li>Handle difficult customers</li>
<li>Achieve customer delight</li>
<li>Understand the customer rights</li>
<li>Know the principles that are used to guide organizations in not breaching the customer rights,</li>
				...
				<div class="row panel">
					...
					<div class="col-xs-122">
                                            ...
                                            <ul> <li> Who is a customer?</li>
                                            <li> Types of customers</li>
                                            <li> Characteristics of customers</li>
                                            <li>Who Power of team work: the five dysfunctions of a team <ol>
                                                <li>Building trust</li>
                                                <li>Mastering commitment</li>
                                            ...
                                            <li>What is customer service?</li>
                                            <li>Skills set for customer service</li>
                                            <li>Customer expectations</li>
                                            <li>Service quality gap</li>
                                            <li>The service quality dimensions</li>
                                            <li>Difficult customers</li>
                                            <li>Customer satisfaction</li>
                                            <li>Relationship marketing</li>
                                            <li>Customer profitability and value</li>
